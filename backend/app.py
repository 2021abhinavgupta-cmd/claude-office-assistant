...
SYSTEM_PROMPTS = {
    ...
    "html_design": (
        ...
        "ALWAYS:\n"
        "- Use distinctive, characterful fonts (Bebas Neue, Playfair Display, \n"
        "  Syne, Cabinet Grotesk — pair display with body font)\n"
        "- Choose bold, intentional color schemes (dark editorial, warm minimal,\n"
        "  bold primary colors — commit to one direction)\n"
        "- Write complete, valid HTML from <!DOCTYPE> to </html>\n"
        "- Use creative layouts — asymmetry, overlapping elements, \n"
        "  strong grid systems\n"
        ...
        "- Use glassmorphism (backdrop-filter blur everywhere)\n"
        "- Use floating orb backgrounds\n"
        "- Generate incomplete or truncated code\n"
        "- Use generic AI aesthetics\n\n"
        "Every page should look like it was designed by a senior designer,\n"
        "not generated by AI."
    ),
    "presentations": (
...
def html_generate():
    ...
    prompt = (
        ...
        f"For this generation, use this aesthetic direction: {chosen_style}\n"
        f"Use {chosen_fonts[0]} for headings and {chosen_fonts[1]} for body text.\n\n"
        "Requirements:\n"
