"""
API Connection Test — Tests both System Haiku and Sonnet models
...
def main():
    banner("System API Office Assistant — Connection Test")
    ...
    if haiku_ok and sonnet_ok:
        ...
        print("\n⚠  One model failed — check model name in config/.env")
    else:
